...
public class LoginPage extends BasePage {
    ...
    public String getErrorMessageText() {
        return findElement(invalidCredentialsErrorMessage).getText();
    }

    public String getRequiredFieldMessageText() {
        return findElement(fieldRequiredValidationMessage).getText();
    }
}